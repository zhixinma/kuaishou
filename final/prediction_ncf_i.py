...
# data_1, user_doc_1, photo_doc_1, train_interaction_1, test_interaction_1, user_reverse_fit_1, photo_reverse_fit_1 = load_interaction()
...
# data, user_doc, photo_doc, train_interaction, test_interaction, user_reverse_fit, photo_reverse_fit = load_interaction_with_text(text_data)
...
gpu_num = 2
ctx = mx.gpu(gpu_num)
myncf = ncf_i(nb_users, nb_photos, nb_words)
